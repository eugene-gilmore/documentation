...
1. To fetch the request ID of your request, open a block explorer to read the transaction details(e.g.: [Goerli Etherscan](https://goerli.etherscan.io/tx/0x7bb8ebc099a3feaaa41e422d56a7e5141df790142fd840d71f74f84b29b103a8#eventlog)). Then click on the _Logs_ tab to see the event logs. Find `WrappedRequestSent` event log and note the `requestId` as you will need it later.
   ![Vrf v2 subscription method request logs](/images/vrf/v2-direct-funding-request-logs.png)
