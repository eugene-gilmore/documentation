...
1. To fetch the request ID of your request, open a block explorer to read the transaction details(e.g.: [Goerli Etherscan](https://goerli.etherscan.io/tx/0xf299c5471c0a16432d150505c5a231ee1508b3cf86b7f71a1289665e0353b04f)). Then click on the _Logs_ tab to see the event logs. Find `RequestSent` event log and note the `requestId` as you will need it later.
